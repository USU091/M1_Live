...
public class Item
{
    ...
    {
        get { return SaveData.TempplateId; }
        set { SaveData.TempplateId = value; }
    }
    ...
    {
        if (Managers.Data.ItemDic.TryGetValue(itemInfo.TempplateId, out ItemData itemData) == false)
            return null;
        ...
        switch(itemData.Type)
        {
            case EItemType.Weapon:
                item = new Equipment(itemInfo.TempplateId);
                break;
            case EItemType.Armor:
                item = new Equipment(itemInfo.TempplateId);
                break;
            case EItemType.Potion:
                item = new Consumable(itemInfo.TempplateId);
                break;
        ...
        if(item  != null)
        {
            ...
            item.InstaceId = itemInfo.InstanceId;
